...
export const projects: Project[] = [
  {
    ...
    highlights: [
      ...
      "<bold>HTPC automation:</bold> Per device control paths - Windows via EventGhost, Linux Wayland/X11 via ydotool, macOS via robotjs",
      "<bold>PWA</bold> — installable from any browser on the local network, swipeable panel layout built for phones",
    ],
  ...
  },
  {
    ...
    stack: ["Laravel", "Inertia", "React", "Claude API", "MariaDB"],
    status: "coming-soon",
